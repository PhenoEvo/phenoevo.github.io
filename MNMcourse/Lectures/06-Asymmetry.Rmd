...
title: |
        (A)symmetry
        <br><img src="LectureData/06.asymmetry/SymmLizard.png" style="width:500px; margin: 20px auto 20px auto;"><br>
...
include_graphics("LectureData/06.asymmetry/SymmTypes.png")  
```
...
include_graphics("LectureData/06.asymmetry/SymmLizard.png")  
```  
...
>-
###### As we have seen, RRPP, combined with robust summary test statistics, does not require inverting (nearly) singular covariance matrices, so model evaluation is not compromised by this issue.
...
include_graphics("LectureData/06.asymmetry/PCASymmLizards.png")  
``` 
...
```{r, echo = FALSE, out.width="30%", fig.align='center'}
include_graphics("LectureData/06.asymmetry/FiddlerCrab.png")  
``` 
...
```{r, echo = FALSE, out.width="80%", fig.align='center'}
include_graphics("LectureData/06.asymmetry/SymmTypesHist.png")  
``` 
...
include_graphics("LectureData/06.asymmetry/AnovaDesign.png")  
``` 

# Extensions to GM Shape Data 

```{r, echo = FALSE, out.width="80%", fig.align='center'}
include_graphics("LectureData/06.asymmetry/ReflectObjects.png")  
```
...
include_graphics("LectureData/06.asymmetry/MatchExWings.png")  
``` 

# Object Symmetry: Example

```{r, echo = FALSE, out.width="85%", fig.align='center'}
include_graphics("LectureData/06.asymmetry/ObjExLizards.png")  
``` 
...
include_graphics("LectureData/06.asymmetry/HigherSymm.png")  
``` 
...
include_graphics("LectureData/06.asymmetry/SymmGroups.png")  
``` 
...
include_graphics("LectureData/06.asymmetry/RadialSymm.png")  
``` 
...
```{r, echo = FALSE, out.width="75%", fig.align='center'}
include_graphics("LectureData/06.asymmetry/CoralSymmetry.png")  
``` 
...
include_graphics("LectureData/06.asymmetry/ArticConcept.png")  
``` 
...
```{r, echo = FALSE, out.width="90%", fig.align='center'}
include_graphics("LectureData/06.asymmetry/ArticMath.png")  
``` 
...
include_graphics("LectureData/06.asymmetry/MotionAnal.png")  
``` 
