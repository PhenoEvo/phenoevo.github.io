...
title: |
        ...
        <br><img src="LectureData/03.shape.vars/Diodon2Mola.png" style="width:400px; margin: 10px auto -60px auto;"><br>
...
```{r echo=FALSE, eval=TRUE, fig.align='center', out.height="30%"}
