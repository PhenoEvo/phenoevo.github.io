...
##### 1: Visualizing Shape Differences and PCA ####
...
# Note: gm.prcomp already provides these shapes!
names(pleth.raw)
names(pleth.raw$shapes)
str(pleth.raw$shapes$shapes.comp1)

##### PickNPlot Shapes in Real Time (more detail here)
