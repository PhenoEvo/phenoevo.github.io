...
- Adjacent points on curve define sliding directions: $\small{U}_{ij}=[(x_j-x_{j+1}),(y_j-y_{j+1})]$
...
- Sliding incorporated into GPA algorithm
    - 1: Translate and scale specimens
    - 2: LS rotation, obtain reference and $\small\mathbf{L}_p^{-1}$
    - 3: Calculate tangent directions $\small\mathbf{U}$  $$\small{U}_{ij}=[(x_j-x_{j+1}),(y_j-y_{j+1})]$$
...
# Procruses Relaxation: Refinements
