...
```{r echo=FALSE, out.width="60%" }
res <- plot(gm.prcomp(Y.gpa$coords), pch = 2, bg = col.gp)
zapsmall(res$sdev)
```
...
```{r, echo = FALSE, out.width="50%"}
  include_graphics("LectureData/02.Superimposition/Pinoccio.png")  
```
...
```{r, echo = FALSE, out.width="80%"}
  include_graphics("LectureData/02.Superimposition/GRF-Example.png")  
```
