...
2: Permute, $\small\mathbf{E}_{R}$: obtain pseudo-values as: $\small\mathscr{Y} = \mathbf{\hat{Y}}_{R} + \mathbf{E}_{R}$

3: Fit $\small\mathbf{X}_{F}$ using $\small\mathscr{Y}$: obtain coefficients and summary statistics
...
```{r, include=TRUE, out.width="80%", fig.align='center'}
data(pupfish)
